#!/usr/bin/env python3
"""
Direct Test for ISM Large Text Templates

This script tests the large text templates directly without importing
the problematic agent module with LightRAG dependencies.
"""
...
# Import only the components we need directly
...
def test_document_saving():
    ...
    try:
        ...
        output_file = output_dir / "direct_test_document.json"
        ...
        text_file = output_dir / "direct_test_document.txt"
...
def main():
    ...
    print("🚀 ISM Large Text Templates Direct Tests")
    print("=" * 60)
    ...
    if passed == total:
        ...
        print("\n📁 Generated files:")
        print("   - generated_documents/ism/direct_test_document.json")
        print("   - generated_documents/ism/direct_test_document.txt")
    else:
