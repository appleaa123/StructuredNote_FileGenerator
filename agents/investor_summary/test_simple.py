#!/usr/bin/env python3
"""
Simple Test for ISM Large Text Templates

This script tests the large text templates directly by importing
the necessary modules without going through the problematic agent module.
"""
...
from models import ISMInput
from large_text_templates import test_your_templates, create_complete_document_from_templates
...
def test_document_saving():
    ...
    try:
        ...
        output_file = output_dir / "simple_test_document.json"
        ...
        text_file = output_dir / "simple_test_document.txt"
...
def main():
    ...
    print("🚀 ISM Large Text Templates Simple Tests")
    print("=" * 60)
    ...
    if passed == total:
        ...
        print("\n📁 Generated files:")
        print("   - generated_documents/ism/simple_test_document.json")
        print("   - generated_documents/ism/simple_test_document.txt")
    else:
