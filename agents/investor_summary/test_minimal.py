#!/usr/bin/env python3
"""
Minimal Test for ISM Large Text Templates

This script tests only the large text templates without any dependencies
on the problematic modules with LightRAG imports.
"""
...
# Test the large text templates directly
def test_large_text_templates():
    ...
    try:
        # Import and test templates
        from large_text_templates import test_your_templates
...
def test_template_variable_substitution():
    ...
    try:
        # Import templates
        from large_text_templates import create_complete_document_from_templates
...
def test_document_saving():
    ...
    try:
        ...
        output_file = output_dir / "minimal_test_document.json"
        ...
        text_file = output_dir / "minimal_test_document.txt"
...
def main():
    ...
    print("🚀 ISM Large Text Templates Minimal Tests")
    print("=" * 60)
    ...
    if passed == total:
        ...
        print("\n📁 Generated files:")
        print("   - generated_documents/ism/minimal_test_document.json")
        print("   - generated_documents/ism/minimal_test_document.txt")
    else:
